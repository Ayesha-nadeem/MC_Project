...
public class database_sqlite extends SQLiteOpenHelper {
    ...
    public database_sqlite(Context context) {
        super(context,  "interviewPrep5", null, 1);
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        v1.put("categoryID","1");
        sqLiteDatabase.insert( "questions",null,v1);
        ...
        v2.put("categoryID","1");
        sqLiteDatabase.insert( "questions",null,v2);
        ...
        v3.put("categoryID","1");
        sqLiteDatabase.insert( "questions",null,v3);
        ...
        v4.put("categoryID","1");
        sqLiteDatabase.insert( "questions",null,v4);
        ...
        v5.put("categoryID","1");
        sqLiteDatabase.insert( "questions",null,v5);
        ...
        v6.put("categoryID","2");
        sqLiteDatabase.insert( "questions",null,v6);
        ...
        v7.put("categoryID","2");
        sqLiteDatabase.insert( "questions",null,v7);
        ...
        v8.put("categoryID","2");
        sqLiteDatabase.insert( "questions",null,v8);
        ...
        v9.put("categoryID","2");
        sqLiteDatabase.insert( "questions",null,v9);
        ...
        sqLiteDatabase.insert( "questions",null,v10);
        ...
        sqLiteDatabase.insert( "questions",null,v11);
        ...
        sqLiteDatabase.insert( "questions",null,v12);
        ...
        sqLiteDatabase.insert( "questions",null,v13);
        ...
        sqLiteDatabase.insert( "questions",null,v14);
        ...
        sqLiteDatabase.insert( "questions",null,v15);
        ...
        sqLiteDatabase.insert( "questions",null,v16);
        ...
        sqLiteDatabase.insert( "questions",null,v17);
        ...
        sqLiteDatabase.insert( "questions",null,v18);
        ...
        sqLiteDatabase.insert( "questions",null,v19);
        ...
        sqLiteDatabase.insert( "questions",null,v20);
        ...
        sqLiteDatabase.insert( "questions",null,v21);
        ...
        sqLiteDatabase.insert( "questions",null,v22);
        ...
        sqLiteDatabase.insert( "questions",null,v23);
        ...
        sqLiteDatabase.insert( "questions",null,v24);
        ...
        sqLiteDatabase.insert( "questions",null,v25);
        ...
        sqLiteDatabase.insert( "questions",null,v26);
        ...
        sqLiteDatabase.insert( "questions",null,v27);
        ...
        sqLiteDatabase.insert( "questions",null,v28);
        ...
        sqLiteDatabase.insert( "questions",null,v29);
        ...
        sqLiteDatabase.insert( "questions",null,v30);
    ...
    public List<QuestionModel> getQuestions(String id)
    {
        int id1=Integer.parseInt(id);
        List<QuestionModel> list=new ArrayList<>();
        SQLiteDatabase db=this.getReadableDatabase();
        Cursor cursor=db.query("questions",null, "categoryId = ?",
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                list.add(new QuestionModel(A,B,C,D,correctOption,question));
            }while (cursor.moveToNext());
        }
        cursor.close();
        return list;
